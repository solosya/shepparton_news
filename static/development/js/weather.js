(function ($) {
    ...
    $(document).ready(function() {
        ...
        var weatherIcons = function(icon) {
            ...
            case 'clear-day':
                return '<svg class="weather-svg" width="37" height="37" viewBox="0 0 37 37">' +
                    '<g fill-rule="evenodd">' +
                ...
                '</svg>';
            case 'clear-night':
                return '<svg class="weather-svg" width="31" height="33" viewBox="0 0 31 33">' +
                ...
                '</svg>';
            case 'cloudy':
                return '<svg class="weather-svg" width="38" height="26" viewBox="0 0 38 26">' +
                    '<g fill-rule="evenodd">' +
            ...
            case 'fog':
                ...
                '</svg>';
            case 'partly-cloudy-day':
                return '<svg class="weather-svg" width="38" height="28" viewBox="0 0 38 28">' +
                    '<defs>' +
                ...
                '</svg>';
            case 'partly-cloudy-night':
                return '<svg class="weather-svg" width="33" height="28" viewBox="0 0 33 28">' +
                    '<g fill-rule="evenodd">' +
            ...
            case 'rain':
                ...
                '</svg>';
            case 'sleet':
                return '<svg class="weather-svg" width="31" height="30" viewBox="0 0 31 30">' +
                    '<g fill-rule="evenodd">' +
            ...
            case 'snow':
                ...
                '</svg>';
            case 'stormy':
                return '<svg class="weather-svg" width="30" height="36" viewBox="0 0 30 36">' +
                    '<g fill-rule="evenodd">' +
                ...
                '</svg>';
            case 'wind':
                return '<svg class="weather-svg" width="38" height="25" viewBox="0 0 38 25">' +
                    '<g fill-rule="evenodd">' +

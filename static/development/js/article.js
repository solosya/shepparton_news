...
Acme.article.prototype.InsertInterstitial = function() {
    ...
    if ($('.article_content > p').length >= 4) {
        $("<div class='ad-container hidden-md hidden-lg mobad1' style='position:relative;width:300px;margin: 0 auto;'><div id='div-gpt-ad-mrec-2' class='card__announcement-image google_ad google_ad_mrec text-center' ></div></div>").insertAfter( $('.article_content > p')[2] );        
